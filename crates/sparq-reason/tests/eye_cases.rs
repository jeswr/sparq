...
fn eye_backward() {
    ...
    // forward rule.
    let input = format!("{}\n{}", include_str!("eye/backward.n3"), include_str!("eye/backward-query.n3"));
...
fn eye_witch() {
    ...
    let input = format!("{}\n{}", include_str!("eye/witch.n3"), include_str!("eye/witch-goal.n3"));
...
fn eye_bi_subset() {
    ...
    check("bi-subset", include_str!("eye/bi-subset.n3"), include_str!("eye/bi-subset-answer.n3"));
}
