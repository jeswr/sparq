...
codec with explicit parser limits, the versioned **client/broker message** codec,
...
> external review; the client-side sync driver, CRDT and materialize are NOT in
> this crate, and the server-side opaque broker lives in `sparq-e2ee-ng-broker`.
