...
//! End-to-end tests of the identity host (provider WebIDs OUTSIDE the pod — RSS
//! `docs/design/webid-outside-pod.md` → `research/lws-design-records.md` §4) through the
//! assembled router:
//!
