...
mod tests {
    ...
    /// All five XML 1.0 §4.6 predefined named entities resolve to their exact characters.
    /// [HAIKU-4.5]
    #[test]
    fn resolve_xml_entity_predefined_named_entities() {
        assert_eq!(super::resolve_xml_entity("amp").unwrap(), "&");
        assert_eq!(super::resolve_xml_entity("lt").unwrap(), "<");
        assert_eq!(super::resolve_xml_entity("gt").unwrap(), ">");
        assert_eq!(super::resolve_xml_entity("quot").unwrap(), "\"");
        assert_eq!(super::resolve_xml_entity("apos").unwrap(), "'");
    }
