...
impl<'i, F: FnMut(Triple)> Machine<'i, F> {
    ...
    fn next_token(&mut self) -> Result<(), PErr> {
        ...
        match c0 {
            ...
            | 86 | 87 | 88 | 89 | 90 | 97 | 98 | 103 | 106 | 107 | 111 | 118 | 119 | 120 | 121
            | 122 => {
    ...
    fn p_targetClass(&mut self, n: Term) -> Result<(), PErr> {
        ...
        loop {
            ...
            if !(matches!(self.tk, T_IRIREF | T_PNAME_LN | T_PNAME_NS)) {
                break;
            }
        }
        Ok(())
        ...
        match self.tk {
            ...
            _ => {
                return Err(self.perr_alt(&[
                    ...
                    T_LIT_42, T_LIT_43, T_LIT_44, T_LIT_58, T_LIT_61, T_PNAME_LN, T_PNAME_NS,
                ]));
            }
        }
        self.depth -= 1;
    ...
    fn p_propertyShape(&mut self, n: Term) -> Result<(), PErr> {
        ...
        while (FS_2 >> self.tk) & 1 != 0 {
            match self.tk {
                ...
                | T_LIT_56 | T_LIT_6 | T_PNAME_LN | T_PNAME_NS => {
    ...
    fn p_pathPrimary(&mut self) -> Result<Term, PErr> {
        ...
        match self.tk {
            ...
            T_LIT_61 => {
                ...
                let p = self.p_pathAlternative()?;
                if self.tk != T_LIT_62 {
                    return Err(self.perr_exp(T_LIT_62));
                }
                self.next_token()?;
                _v = p.clone();
            }
