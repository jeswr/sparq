...
//! `#![forbid(unsafe_code)]`-compatible; zero dependencies beyond std.
//!
...
const FS_0: u128 = 0x90007fffffffd00000e; // { T_IRIREF, T_LIT_10, T_LIT_12, T_LIT_13, T_LIT_14, T_LIT_15, T_LIT_16, T_LIT_17, T_LIT_18, T_LIT_19, T_LIT_20, T_LIT_21, T_LIT_22, T_LIT_23, T_LIT_24, T_LIT_25, T_LIT_26, T_LIT_27, T_LIT_28, T_LIT_29, T_LIT_30, T_LIT_31, T_LIT_32, T_LIT_33, T_LIT_34, T_LIT_35, T_LIT_36, T_LIT_37, T_LIT_38, T_LIT_39, T_LIT_40, T_LIT_41, T_LIT_42, T_LIT_43, T_LIT_44, T_LIT_58, T_LIT_61, T_PNAME_LN, T_PNAME_NS }
const FS_1: u128 = 0x7fffffffd000000; // { T_LIT_10, T_LIT_12, T_LIT_13, T_LIT_14, T_LIT_15, T_LIT_16, T_LIT_17, T_LIT_18, T_LIT_19, T_LIT_20, T_LIT_21, T_LIT_22, T_LIT_23, T_LIT_24, T_LIT_25, T_LIT_26, T_LIT_27, T_LIT_28, T_LIT_29, T_LIT_30, T_LIT_31, T_LIT_32, T_LIT_33, T_LIT_34, T_LIT_35, T_LIT_36, T_LIT_37, T_LIT_38, T_LIT_39, T_LIT_40, T_LIT_41, T_LIT_42, T_LIT_43, T_LIT_44 }
const FS_2: u128 = 0x7f8fffffffe110003e; // { T_ATPNAME_LN, T_ATPNAME_NS, T_IRIREF, T_LIT_10, T_LIT_15, T_LIT_16, T_LIT_17, T_LIT_18, T_LIT_19, T_LIT_20, T_LIT_21, T_LIT_22, T_LIT_23, T_LIT_24, T_LIT_25, T_LIT_26, T_LIT_27, T_LIT_28, T_LIT_29, T_LIT_30, T_LIT_31, T_LIT_32, T_LIT_33, T_LIT_34, T_LIT_35, T_LIT_36, T_LIT_37, T_LIT_38, T_LIT_39, T_LIT_40, T_LIT_41, T_LIT_42, T_LIT_43, T_LIT_44, T_LIT_45, T_LIT_49, T_LIT_50, T_LIT_51, T_LIT_52, T_LIT_53, T_LIT_54, T_LIT_55, T_LIT_56, T_LIT_6, T_PNAME_LN, T_PNAME_NS }
const FS_3: u128 = 0x320000000000000003f8e; // { T_DECIMAL, T_DOUBLE, T_INTEGER, T_IRIREF, T_LIT_63, T_LIT_66, T_LIT_67, T_PNAME_LN, T_PNAME_NS, T_STRING_LITERAL_LONG_QUOTE, T_STRING_LITERAL_LONG_SINGLE_QUOTE, T_STRING_LITERAL_QUOTE, T_STRING_LITERAL_SINGLE_QUOTE }
...
fn next_token(&mut self) -> Result<(), PErr> {
    ...
    match c0 {
        ...
        58 | 65 | 67 | 68 | 69 | 70 | 71 | 72 | 74 | 75 | 77 | 78 | 79 | 81 | 82 | 83 | 85 | 86 | 87 | 88 | 89 | 90 | 97 | 98 | 103 | 106 | 107 | 111 | 118 | 119 | 120 | 121 | 122 => {
...
if !(matches!(self.tk, T_IRIREF | T_PNAME_LN | T_PNAME_NS)) { break; }
}
Ok(())
}
...
if !((FS_1 >> self.tk) & 1 != 0) { break; }
}
if self.tk != T_LIT_8 { return Err(self.perr_exp(T_LIT_8)); }
self.next_token()?;
}
T_IRIREF | T_LIT_58 | T_LIT_61 | T_PNAME_LN | T_PNAME_NS => {
...
fn p_pcSection(&mut self, _ps: Term) -> Result<(), PErr> {
...
let _v: Term;
match self.tk {
T_IRIREF | T_LIT_61 | T_PNAME_LN | T_PNAME_NS => {
...
_ => {
return Err(self.perr_alt(&[T_IRIREF, T_LIT_58, T_LIT_61, T_PNAME_LN, T_PNAME_NS]));
}
}
self.depth -= 1;
Ok(_v)
...
_ => {
return Err(self.perr_alt(&[T_LIT_48, T_LIT_59, T_LIT_60]));
}
}
Ok(_v)
}
...
self.next_token()?;
let p = self.p_pathAlternative()?;
if self.tk != T_LIT_62 { return Err(self.perr_exp(T_LIT_62)); }
self.next_token()?;
_v = p.clone();
}
_ => {
return Err(self.perr_alt(&[T_IRIREF, T_LIT_61, T_PNAME_LN, T_PNAME_NS]));
}
}
self.depth -= 1;
Ok(_v)
...
let _v: Term;
match self.tk {
T_DECIMAL | T_DOUBLE | T_INTEGER | T_IRIREF | T_LIT_63 | T_LIT_66 | T_LIT_67 | T_PNAME_LN | T_PNAME_NS | T_STRING_LITERAL_LONG_QUOTE | T_STRING_LITERAL_LONG_SINGLE_QUOTE | T_STRING_LITERAL_QUOTE | T_STRING_LITERAL_SINGLE_QUOTE => {
...
_ => {
return Err(self.perr_alt(&[T_DECIMAL, T_DOUBLE, T_INTEGER, T_IRIREF, T_LIT_45, T_LIT_63, T_LIT_66, T_LIT_67, T_PNAME_LN, T_PNAME_NS, T_STRING_LITERAL_LONG_QUOTE, T_STRING_LITERAL_LONG_SINGLE_QUOTE, T_STRING_LITERAL_QUOTE, T_STRING_LITERAL_SINGLE_QUOTE]));
}
}
Ok(_v)
}
...
T_DECIMAL | T_DOUBLE | T_INTEGER | T_LIT_66 | T_LIT_67 | T_STRING_LITERAL_LONG_QUOTE | T_STRING_LITERAL_LONG_SINGLE_QUOTE | T_STRING_LITERAL_QUOTE | T_STRING_LITERAL_SINGLE_QUOTE => {
...
_ => {
return Err(self.perr_alt(&[T_DECIMAL, T_DOUBLE, T_INTEGER, T_IRIREF, T_LIT_63, T_LIT_66, T_LIT_67, T_PNAME_LN, T_PNAME_NS, T_STRING_LITERAL_LONG_QUOTE, T_STRING_LITERAL_LONG_SINGLE_QUOTE, T_STRING_LITERAL_QUOTE, T_STRING_LITERAL_SINGLE_QUOTE]));
}
}
Ok(_v)
}
...
_ => {
return Err(self.perr_alt(&[T_DECIMAL, T_DOUBLE, T_INTEGER, T_LIT_66, T_LIT_67, T_STRING_LITERAL_LONG_QUOTE, T_STRING_LITERAL_LONG_SINGLE_QUOTE, T_STRING_LITERAL_QUOTE, T_STRING_LITERAL_SINGLE_QUOTE]));
}
}
Ok(_v)
}
...
_ => {
return Err(self.perr_alt(&[T_LIT_66, T_LIT_67]));
}
}
Ok(_v)
}
...
fn fm_LANG_DIR(s: &str) -> bool {
    let mut fl = Fl::default();
    m_LANG_DIR(s.as_bytes(), 0, &mut fl) == s.len() as isize
}
...
const RS_EXT_ANNOTATION: bool = false;
const RS_EXT_PC: bool = false;
const RS_EXT_TTL: bool = false;
const RS_MIN_GUARDED: bool = true;
const RS_HAS_TT: bool = true;
const RS_EMPTY_ARRAY: bool = true;

const V_RDF_TYPE: &str = "http://www.w3.org/1999/02/22-rdf-syntax-ns#type";
const V_ONTOLOGY: &str = "http://www.w3.org/2002/07/owl#Ontology";
const V_IMPORTS: &str = "http://www.w3.org/2002/07/owl#imports";
const V_NODESHAPE: &str = "http://www.w3.org/ns/shacl#NodeShape";
const V_RDFS_CLASS: &str = "http://www.w3.org/2000/01/rdf-schema#Class";
const V_TARGETCLASS: &str = "http://www.w3.org/ns/shacl#targetClass";
const V_PROPERTY: &str = "http://www.w3.org/ns/shacl#property";
const V_PATH: &str = "http://www.w3.org/ns/shacl#path";
const V_MINCOUNT: &str = "http://www.w3.org/ns/shacl#minCount";
const V_MAXCOUNT: &str = "http://www.w3.org/ns/shacl#maxCount";
const V_OR: &str = "http://www.w3.org/ns/shacl#or";
const V_NOT: &str = "http://www.w3.org/ns/shacl#not";
const V_NODE: &str = "http://www.w3.org/ns/shacl#node";
const V_DATATYPE: &str = "http://www.w3.org/ns/shacl#datatype";
const V_CLASS: &str = "http://www.w3.org/ns/shacl#class";
const V_NODEKIND: &str = "http://www.w3.org/ns/shacl#nodeKind";
const V_RDF_FIRST: &str = "http://www.w3.org/1999/02/22-rdf-syntax-ns#first";
const V_RDF_REST: &str = "http://www.w3.org/1999/02/22-rdf-syntax-ns#rest";
const V_RDF_NIL: &str = "http://www.w3.org/1999/02/22-rdf-syntax-ns#nil";
const V_ALTPATH: &str = "http://www.w3.org/ns/shacl#alternativePath";
const V_INVERSE: &str = "http://www.w3.org/ns/shacl#inversePath";
const V_XSD_INTEGER: &str = "http://www.w3.org/2001/XMLSchema#integer";
const V_XSD_STRING: &str = "http://www.w3.org/2001/XMLSchema#string";
const V_LANGSTRING: &str = "http://www.w3.org/1999/02/22-rdf-syntax-ns#langString";
const V_DIRLANGSTRING: &str = "http://www.w3.org/1999/02/22-rdf-syntax-ns#dirLangString";

const K_BASE: &str = "BASE";
const K_IMPORTS: &str = "IMPORTS";
const K_PREFIX: &str = "PREFIX";
const K_SHAPE: &str = "shape";
const K_SHAPECLASS: &str = "shapeClass";
const K_ARROW: &str = "->";
const K_NOT: &str = "!";
const K_OR: &str = "|";
const K_REF: &str = "@";
const K_DOT: &str = ".";
const K_BODY_OPEN: &str = "{";
const K_BODY_CLOSE: &str = "}";
const K_CNT_OPEN: &str = "[";
const K_CNT_DOTS: &str = "..";
const K_CNT_CLOSE: &str = "]";
const K_ARR_OPEN: &str = "[";
const K_ARR_CLOSE: &str = "]";
const K_PAR_OPEN: &str = "(";
const K_PAR_CLOSE: &str = ")";
const K_PATH_SEQ_SEP: &str = "/";
const K_INVERSE: &str = "^";
const K_DT_SEP: &str = "^^";
const K_TT_OPEN: &str = "<<(";
const K_TT_CLOSE: &str = ")>>";
const K_ANN_SEP: &str = ";";
const K_OBJ_SEP: &str = ",";
const K_PC_OPEN: &str = "%";
const K_PC_CLOSE: &str = "%";
const K_BN_OPEN: &str = "[";
const K_BN_CLOSE: &str = "]";
const K_LIST_OPEN: &str = "(";
const K_LIST_CLOSE: &str = ")";
const K_MIN_DEFAULT: &str = "0";
const K_MAX_DEFAULT: &str = "*";
...
pub fn write_triples(
    ...
    if let Some(missing) = r.missing {
        return Err(ResidualError {
            message: format!(
                "shaclc12ext: not printable — the document clause re-emits <{}> rdf:type owl:Ontology, which the graph does not contain",
    ...
    if !r.residual.is_empty() {
        return Err(ResidualError {
            message: format!(
                "shaclc12ext: graph is not compact-expressible in this profile — {} residual triple(s)",
                r.residual.len()
            ),
            residual: r.residual,
            missing: None,
