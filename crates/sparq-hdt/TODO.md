# sparq-hdt — outstanding work

Tracked in beads (not here). Run `bd ready -l area:sparq-hdt` or
`bd list -l area:sparq-hdt`. See AGENTS.md for the no-markdown-TODOs policy.
...
### Write support — blocked-upstream (re-verified 2026-06-12; tracked in beads)
...
### hdt crate version pin — KEPT (re-verified 2026-06-12; bump tracked in beads)
...
### Loader gaps (upstream API shape) — blocked-upstream (tracked in beads)
