...
ontology is inside the ALCH fragment by construction; a branch that DECIDED is never pre-empted, an abstaining tableau returns the branch's own reason unchanged, and the PR1 punning
