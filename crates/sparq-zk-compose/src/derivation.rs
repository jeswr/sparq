...
/// (`sq-rsd3v.6`, NOT `.7` — that is the distinct completeness obligation above)
/// — encoding-equality re-checks are UNSOUND under equality reasoning — and must
/// never ride this fixed-shape path.
///
