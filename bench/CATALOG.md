...
| **compression** | index / result-serialization footprint tradeoffs; bytes/triple at scale | `cli-probe-compress`, `cli-compare-compress`, `compress-bench`, `bytes-per-triple` |
