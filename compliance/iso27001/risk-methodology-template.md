...
| R-2 | Memory-safety UB in unsafe mmap path (T-Corrupt, B5) | AS-2 | `#![forbid(unsafe_code)]` in 30/35 crates; Miri lane; fuzz; mmap corruption oracle; `compliance/memsafety/`; `controls.md` A.8.27/A.8.29 | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` |
