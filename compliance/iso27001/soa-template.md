...
| A.8.27 | Secure system architecture & engineering principles | IMPL | `#![forbid(unsafe_code)]` in 26/31 crates; boundary threat model; defense-in-depth gate stack; `compliance/memsafety/unsafe-register.md` | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` |
