...
| A.8.27 | Secure system architecture & engineering principles | IMPL | `#![forbid(unsafe_code)]` in 30/35 crates; boundary threat model; defense-in-depth gate stack; `compliance/memsafety/unsafe-register.md` | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` | `<FILL-IN>` |
