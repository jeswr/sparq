...
**Status of the 35 control rows: 27 implemented & verified, 6 audit-ready, 2 gap** (see
...
link is asserted, not independently reproducible). **RESOLVED:** (GS-3 / sq-toze.27) the
