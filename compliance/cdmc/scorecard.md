...
| 2 — Cataloguing & Classification | ~3.5 | **A genuine sparq strength** — VoID/SD catalogue + SHACL classification hooks. |
...
**Overall honest posture:** sparq is **strongest where it is an engine** (technical architecture,
cataloguing surface, security controls — 4s) and **deliberately weak where the capability is a
