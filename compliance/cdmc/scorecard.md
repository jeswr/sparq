...
| 4 | Protection & Privacy | 4.1 Data is secured & controls are evidenced | **4** | Deep, CI-gated security estate: `#![forbid(unsafe_code)]` (31/36 crates), Miri/fuzz, CodeQL (advisory at merge since 2026-07-17; retroactive alert triage), supply-chain attestation, DoS limits, distroless image. |
