...
| 4 | Protection & Privacy | 4.1 Data is secured & controls are evidenced | **4** | Deep, CI-gated security estate: `#![forbid(unsafe_code)]` (26+ crates), Miri/fuzz, CodeQL, supply-chain attestation, DoS limits, distroless image. |
