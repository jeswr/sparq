...
| **SLSA** | **Build Level 2** for release archives + ghcr container (honestly claimed). **L3 NOT met** (in-band provenance ceiling); dist binaries + published packages unattested (P1). |
