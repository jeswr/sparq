...
| **SLSA Build L3** (isolated trusted builder) — L2 is the honest ceiling today; sq-toze.25 wired the isolated builder for the release **archives**, but it is tag-triggered and has not run yet, and the container/GUI/SBOM/dist artifacts are still in-band | slsa | GX-11 / `sq-toze.25` |
