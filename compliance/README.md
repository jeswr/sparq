...
| **ISO/IEC 27001** | [`iso27001/`](./iso27001/) | Annex A control mapping (org-readiness pack, not a certificate) | **Zero open Annex-A control gaps**; two readiness gaps | ISMS/SoA org act (GAP-ISO-1) |
