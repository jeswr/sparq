...
| **ISO/IEC 27001** | [`iso27001/`](./iso27001/) | Annex A control mapping (org-readiness pack, not a certificate) + operator deployment-security doc (B3) | **Zero open Annex-A control gaps**; one open readiness gap (GAP-ISO-2 operator-doc addressed) | ISMS/SoA org act (GAP-ISO-1) |
