...
| **SLSA Build L3** (isolated trusted builder) — **L2 is the honest ceiling today**; the archives' isolated-builder lane is wired (sq-toze.25) but unexercised, and the other artifacts are still in-band | slsa | finish the trusted-builder migration + one `v*` tag as evidence | GX-11 / `sq-toze.25` (P3) |
