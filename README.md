...
> (inference floor committed at [`inference-conformance-report.md`](inference-conformance-report.md)).
> SERVICE federation is not yet implemented (see [`research/roadmap.md`](research/roadmap.md)).
