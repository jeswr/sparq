<!-- DRAFT — proposed .claude/agents/sparq-rust-impl.md; staged because .claude/agents is Self-Modification-protected (AGENTS.md rule 11). Maintainer: move into .claude/agents/. [OPUS-4.8] -->
---
