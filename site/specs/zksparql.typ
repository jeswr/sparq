...
+ *One-directional equivalence.* For the bounded evaluation, $eval_k(P) subset.eq eval(P)$:
...
#table(
  ...
  [`BOUND`], [IN (phase 3, static)], [With `OPTIONAL` out, the query text determines boundness.],
